            ...
            {{-- Your Form Should Inside Down Here --}}
                ...
                <div class="max-w-md p-4 mx-auto my-10 bg-white rounded-md shadow-sm">
                    <div class="text-center">
                        <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Buat Kelas</h1>
                        <p class="text-gray-400 dark:text-gray-400">Silahkan buat Kelas</p>
                    </div>
                    <div class="m-7">
                        <form class="w-full max-w-sm">
                            ...
                            <div class="relative flex items-center py-2 mb-2 border-b border-teal-500">
                                <input type="hidden" wire:model='idkelas' id="idkelas">
                                <input wire:model.defer='tingkat' class="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none" type="text" placeholder="Tingkat" aria-label="tingkat">
                                @error('tingkat')
                                    <h1 class="text-red-500">{{ $message }}</h1>
                                @enderror
                            </div>
                            <div class="flex items-center py-2 mb-2 border-b border-teal-500">
                                <input wire:model.defer='jurusan' class="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none" type="text" placeholder="Jurusan" aria-label="jurusan">
                                @error('jurusan')
                                    <h1 class="text-red-500">{{ $message }}</h1>
                                @enderror
                            </div>
